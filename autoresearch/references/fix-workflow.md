...
- Never use `any` as an escape hatch; it defeats type safety and hides underlying issues
- Never delete or skip a failing test; it removes a critical safety net. Fix the implementation to satisfy the test
